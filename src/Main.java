...
public class Main {
    ...
    private static void editTask(TaskService taskService, Scanner scanner) throws InvalidPropertiesFormatException {
    ...
    private static void addTask(TaskService taskService, Scanner scanner) throws InvalidPropertiesFormatException {
        System.out.println("Введите заголовок задачи");
        String name = scanner.next();
        scanner.nextLine();
        System.out.println("Введите описание задачи:");
